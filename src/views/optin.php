...
<div class="stellarwp-telemetry wrapper" data-js="optin-modal">
	<section class="stellarwp-telemetry modal">
		...
		<footer>
			<form method="post" action="">
				...
				<button class="btn-primary" type="submit" name="optin-agreed" value="true">Allow &amp; Continue</button>
				<button data-js="close-modal" class="btn-text" type="submit" name="optin-agreed" value="false">Skip</button>
			</form>
		</footer>
	</section>
</div>
